  ...
  electricCar: [
    ...
    },
    {
      media: [
        ...
        "assets/electricCar/chevroletblt/1 (5).jpg",
        "assets/electricCar/chevroletblt/1 (4).jpg",
      ],
    ...
    {
      media: ["assets/electricCar/ioniq5/1 (2).jpg"],
    ...
    {
      media: ["assets/electricCar/sonata/1 (2).jpg"],
      name: "Hyundai Sonata",
      pricePerDay: "$100",
      description: "Compact electric car perfect for city driving.",
      location: "Los Angeles, CA",
    ...
    {
      media: ["assets/electricCar/TeslaRoadster/1 (10).jpg"],
      name: "Tesla Roadster",
      pricePerDay: "$100",
      description: "Compact electric car perfect for city driving.",
      location: "Los Angeles, CA",
    ...
    {
      media: ["assets/electricCar/BMW i5/1 (2).jpg"],
      name: "BMW I5",
      pricePerDay: "$100",
      description: "Compact electric car perfect for city driving.",
      location: "Los Angeles, CA",
    ...
    {
      media: ["assets/electricCar/Fisker Ocean/1 (10).jpg"],
      name: "Fisker Ocean",
      pricePerDay: "$100",
      description: "Compact electric car perfect for city driving.",
      location: "Los Angeles, CA",
    ...
    {
      media: ["assets/electricCar/hyundai stragezer/1 (7).jpg"],
    ...
    {
      media: ["assets/electricCar/Wuling Air EV/1 (9).webp"],
      name: "Wuling Air EV",
      pricePerDay: "$100",
      description: "Compact electric car perfect for city driving.",
      location: "Los Angeles, CA",
